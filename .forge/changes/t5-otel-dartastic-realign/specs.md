# Specifications: t5-otel-dartastic-realign
<!-- Status: specified -->
<!-- Schema: default -->
...
(Q-001..Q-003) deferred to `/forge:design` resolution.
...
> **Next step** : `/forge:design t5-otel-dartastic-realign` to
> produce ADR-T53-001 (Q-001 — shim vs SDK choice), ADR-T53-002
> (Q-002 — beta API waiver), ADR-T53-003 (Q-003 — forward-pointer
> convention) plus the implementation strategy + diff strategy
> for the 11 H2 sections + the 5 Dart files.
