...
# FR-T51-127 / NFR-T51-005 — forge-ci.yml ≤ 420 lines (bumped 300→340 2026-06-23
# by b7-7-example's MODIFIED FR-CI-012 second-tree RAG gate; 340→380 2026-06-23 by
# b7-6-harness for the new harness-rust job; 380→400 2026-07-12 by b6-7-harness for
# the event-driven-eu promotion gate's harness-rust L2 step; 400→420 2026-07-12 by
# b6-8-example for the third-tree EDA gate + the b6-8.test.sh loop entry; kept in
# sync with the sibling NFR-CI-002 assertions in c1.test.sh / g1.test.sh /
# t5-otel-live-run.test.sh).
