...
# FR-T51-127 / NFR-T51-005 — forge-ci.yml ≤ 400 lines (bumped 300→340 2026-06-23
...
# the event-driven-eu promotion gate's harness-rust L2 step; kept in sync with the
...
_test_t51_l1_017_ci_line_budget() {
  ...
  if [ "$lines" -gt 400 ]; then
    echo "    forge-ci.yml is $lines lines, exceeds NFR-CI-002 / NFR-T51-005 budget of 400" >&2
    return 1
  fi
}
